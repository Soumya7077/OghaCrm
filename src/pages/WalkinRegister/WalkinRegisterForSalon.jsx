...
const WalkinRegisterForSalon = () => {
  ...
  useEffect(() => {
    axios({
      method: "get",
      url: "https://ogha.onrender.com/salonpackages"
    }).then((res) => {
            ...
            <form className="create-user-form shadow-lg rounded p-3" onSubmit={handleSubmit} encType="multipart/form-data">
              ...
              <div className="mb-3">
                <div className='mt-2'>
                  ...
                  <Link to="/receptionwalkinstaff" className="btn " style={{ color: '#0088CE', border: '0.5px solid #A8A8A9' }}>
                    Cancel
                  </Link>
                </div>
              </div>
...
export default WalkinRegisterForSalon;