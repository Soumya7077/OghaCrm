                                    ...
                                    <div key={gym.id} className="card m-2" style={{ borderRadius: "5px", border: "0px solid white", width: "220px", height: "430px" }}>
                                      <center>
                                        ...
                                        <div className='bg-light' style={{ borderRadius: "5px" }}>
                                          ...
                                          <button type="button" className="btn m-3" style={{ fontSize: "14px", borderRadius: "10px", border: '0.5px solid #0088CE', color: '#A8A8A9' }}>Click Here</button>
...
export default WalkinRegisterForGym;