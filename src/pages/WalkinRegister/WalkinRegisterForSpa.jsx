...
const WalkinRegisterForSpa = () => {
  ...
  useEffect(() => {
    axios({
      method: "get",
      url: "https://ogha.onrender.com/spapackages"
    }).then((res) => {
        ...
        <div className="row justify-content-center">
          <div className="col-lg-10">
            <form className="create-user-form shadow-lg rounded p-3" onSubmit={handleSubmit} encType="multipart/form-data">
                                    ...
                                    <div key={gym.id} className="card m-2" style={{ borderRadius: "5px", border: "0px solid white", width: "220px", height: "430px" }}>
                                      <center>
                                        ...
                                        <div className='bg-light' style={{ borderRadius: "5px" }}>
                                          ...
                                          <button type="button" className="btn m-3" style={{ fontSize: "14px", border: '0.5px solid #A8A8A9', borderRadius: "10px", color: '#0088CE' }}>Click Here</button>
              ...
              <div className="mb-3">
                <div className='mt-2'>
                  <button type="submit" className="btn me-2" style={{ border: '0.5px solid #0088CE', color: '#A8A8A9' }}>
                    {"Submit"}
                  </button>
                  <Link to="/receptionwalkinstaff" className="btn" style={{ border: '0.5px solid #A8A8A9', color: '#0088CE' }}  >
                    Cancel
                  </Link>
                </div>
              </div>
...
export default WalkinRegisterForSpa;