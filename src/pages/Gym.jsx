          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              <input type="email" className="form-control w-75" placeholder="Enter Email Here" />
               ...
               <Card sx={{ width: 350, backgroundColor: '#ebedef', color: 'black', }} >
          <CardActionArea>
            {/* <CardMedia
              sx={{ height: 300 }}
            ...
            <CardContent>
                ...
                <Typography gutterBottom variant="h5" color="#007bff" component="div" className="text-center">
                  GET YOUR MEMBERSHIP AT
                </Typography>
                <Typography variant="body" color="text.dark" className="text-center">
                  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                  Rs. 10000 Monthly
                </Typography>          
              <Typography gutterBottom color="#007bff" variant="h5" component="div" className="text-center">
                  Package Description
                </Typography>
                <Typography variant="body" color="text.dark">
                  <ul>
                    <li>State-of-the-Art Facilities: Gain access to our cutting-edge gym equipped with the latest exercise machines, free weights, cardio equipment, and more. Experience an environment that motivates and supports your fitness goals.</li>
                    <li>State-of-the-Art Facilities: Gain access to our cutting-edge gym equipped with the latest exercise machines, free weights, cardio equipment, and more. Experience an environment that motivates and supports your fitness goals.</li>
                    <li>State-of-the-Art Facilities: Gain access to our cutting-edge gym equipped with the latest exercise machines, free weights, cardio equipment, and more. Experience an environment that motivates and supports your fitness goals.</li>
                  </ul>
                </Typography>
...
export default WalkinRegisterGym;